...
import { ChevronRight, Home, FileText, BarChart, Handshake, Users } from 'lucide-react';
import Navbar from "@/components/navigation/Navbar";
import AuthModal from "@/components/auth/AuthModal";
import AboutReports from '@/components/about/AboutReports';

export default function AboutReportsPage() {
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-8">
          ...
          <ChevronRight className="w-3.5 h-3.5 mx-1" />
          <span className="text-[#09869a] font-medium">Annual Reports</span>
        </div>
