            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gray-50 p-6 rounded-xl border-t-4 border-[#7367F0]">
                    <div className="w-12 h-12 bg-[#7367F0]/10 rounded-full flex items-center justify-center mb-4">
                      <Hammer className="w-6 h-6 text-[#7367F0]" />
                    </div>
                    <h3 className="font-bold text-lg mb-2">45+</h3>
                    <p className="text-gray-600">Classrooms Renovated</p>
                  </div>

                  <div className="bg-gray-50 p-6 rounded-xl border-t-4 border-[#7367F0]">
                    <div className="w-12 h-12 bg-[#7367F0]/10 rounded-full flex items-center justify-center mb-4">
                      <Ruler className="w-6 h-6 text-[#7367F0]" />
                    </div>
                    <h3 className="font-bold text-lg mb-2">35+</h3>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border-t-4 border-[#7367F0]">
                    ...
                    <h3 className="font-bold text-lg mb-2">15,000+</h3>
